...
<br>
        ...
        <div class="card bg-white">
            ...
            <form action="{{url('admin/storebranchname')}}" id="qcat" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                 ...
                 <div class="col-md-6">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="branch_name" placeholder="Enter Bank Name" class="form-control">
                      </div>
                  </div>
