              ...
              <div class="col-md-6">
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name="bank_id">
                            <option value="{{$bankdata->}}">{{$bankdata->bank_name}}</option>
                 ...
                 <div class="col-md-6">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="{{$bankdata->reg_no}}" name="reg_no" placeholder="Enter Reg.No" class="form-control">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" value="{{$bankdata->account_number}}"  name="account_number" placeholder="Enter Bank Account Number" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" name="amount" value="{{$bankdata->amount}}"  placeholder="Enter Amount" class="form-control">
                    </div>
                  </div>
