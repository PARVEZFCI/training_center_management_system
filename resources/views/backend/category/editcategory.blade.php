...
<br>
        ...
        <div class="card bg-white">
            ...
            <form action="{{url('admin/updatecategory')}}" id="qcat" method="post" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row">
                ...
                <input value="{{$category->id}}" type="hidden" class="form-control"  name="id">
                      <div class="form-group">
                          ...
                          <input required="" value="{{$category->category_name}}" type="text" class="form-control"  name="categories" placeholder="Enter Category Name">
                      </div>
                  </div>
