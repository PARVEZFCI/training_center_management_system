...
<td>
    <h3>{{$earningname->earning_name}}</h3>
</td>
...
@endphp
<tr>
    <td  style="border-left: 1px solid rgb(0,0,0);border-bottom: 1px solid rgb(0,0,0);border-right: 1px solid rgb(0,0,0);width:20%">{{$i}}</td>
...
<tr>
    ...
    <td  style="border-bottom: 1px solid rgb(0,0,0);border-right: 1px solid rgb(0,0,0); "><b>{{$total_earn}}</b></td>
</tr>
